"""D-Bus client for communicating with the LightFlowD daemon.

This module provides a client interface for the LightFlow UI to query
...
class LightFlowDaemonClient:
    """Client for communicating with the LightFlowD daemon via D-Bus.

    Provides methods to query cache status, indexing progress, and
    subscribe to daemon signals.
    """

    BUS_NAME = "cloud.ivanbotty.LightFlowD"
    OBJECT_PATH = "/cloud/ivanbotty/LightFlowD"
    INTERFACE_NAME = "cloud.ivanbotty.LightFlowD"
