"""D-Bus service for LightFlowD daemon.

This module provides a D-Bus service that allows the LightFlow UI to communicate
...
<node>
  <interface name="cloud.ivanbotty.LightFlowD">
...
class LightFlowDDBusService:
    """D-Bus service for the LightFlowD daemon.
